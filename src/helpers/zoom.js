        ...
        to: function (options) {
            ...
            if (level !== 1) {
                ...
                if (options.element) {
                    ...
                    var padding = typeof options.padding === 'number' ? options.padding : 5;
...
// export default Vue.directive('zoom', {
//     inserted: function (el) {
//         el.addEventListener('mousedown', () => zoom(el))
//     }
// })

export const ZoomDirective = {
    mounted: function (el) {
        el.addEventListener('mousedown', () => zoom.to({
            element: el, pan: false
        }))
    }
}